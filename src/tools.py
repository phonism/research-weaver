...
class ReadTool:
    ...
    async def read_url(self, url: str) -> str:
        ...
        if scraped_content:
            print(f"Using cached content for {url[:50]}...")
    ...
    def _cache_content(self, url: str, content: str):
        ...
        try:
            ...
            print(f"Cached scraped content for {url[:50]}...")
        except Exception as e:
            print(f"Error caching ReadTool content: {e}")
...
def create_tools():
    ...
    read_tool = ReadTool(search_tool=search_tool)
